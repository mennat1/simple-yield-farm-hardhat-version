...
exports.decodeAbi = exports.getCodeFromAbi = void 0;
function getCodeFromAbi(element) {
    let code;
    ...
    if (element.outputs && element.outputs.length > 0) {
        ...
        for (let i = 0; i < element.outputs.length; i += 1) {
            ...
            if (element.outputs[i].name)
                code += ' ';
            code += element.outputs[i].name;
            if (i + 1 < element.outputs.length)
                code += ', ';
        }
        code += ')';
    }
...
exports.getCodeFromAbi = getCodeFromAbi;
function decodeAbi(abi) {
    const doc = {
        methods: {},
        events: {},
        errors: {},
...
//# sourceMappingURL=abiDecoder.js.map